...
class LaneLines:
    ...
    def fit_poly(self, img):
        ...
        print(f'Left lane pixels detected: {len(lefty)}, Right lane pixels detected: {len(righty)}')
        if len(lefty) > 1500:
        ...
        if self.left_fit is None or self.right_fit is None:
            ...
            return out_img  # Return without drawing lanes  # Return the output image without drawing lanes
